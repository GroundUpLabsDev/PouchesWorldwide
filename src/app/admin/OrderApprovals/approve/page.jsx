  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen">
        ...
        <div className="container mx-auto pt-4 w-[1010px] h-[454px]">
          ...
          <div className="flex flex-col md:flex-row items-start  justify-between">
            ...
            <div className="border rounded-lg p-6 shadow-md w-full md:w-1/2">
              ...
              <div className="mb-[20px]">
                <p className="text-[#282f44] text-sm font-semibold">Requested Price</p>
                <p className="text-[#282f44] text-2xl font-semibold">50$</p>
              </div>
              <div className="mb-[20px]">
                <p className="text-[#282f44] text-sm font-semibold">Number Of Cans</p>
                <p className="text-[#282f44] text-2xl font-semibold">1000</p>
              </div>
              <div className="mb-[20px]">
                <p className="text-[#282f44] text-sm font-semibold">Total</p>
