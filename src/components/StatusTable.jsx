        ...
        <tbody>
          {tableData.map((item, index) => (
            <tr key={index}>
              ...
              <td className="text-black text-lg font-medium font-['Poppins']">{item.price} $</td>
              <td className="text-black text-lg font-medium font-['Poppins']">{item.quantity * item.price} $</td>
            </tr>
          ))}
        </tbody>
      </table>
